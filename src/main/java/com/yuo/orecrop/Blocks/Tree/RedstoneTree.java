...
public class RedstoneTree extends Tree {
    //树木生成配置
    private static final TreeFeatureConfig ORE_TREE_CONFIG = (new TreeFeatureConfig.Builder(
            ...
            new SimpleBlockStateProvider(BlockRegistry.redstoneLeaf.get().getDefaultState()), //树叶
            new BlobFoliagePlacer(2, 0)))
            .baseHeight(5).heightRandA(2).foliageHeight(3).ignoreVines()   //大小形状
            .setSapling((IPlantable) BlockRegistry.redstoneSapling.get()).build(); //树苗
