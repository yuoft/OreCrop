...
public class BlockRegistry {
	...
	public static RegistryObject<Block> redstoneLeanOre = BLOCKS.register("redstone_lean_ore", () -> {
		return new RedstoneStemGrown(Block.Properties.from(Blocks.REDSTONE_BLOCK));
	});
    public static RegistryObject<Block> netheriteLeanOre = BLOCKS.register("netherite_lean_ore", () -> {
        return new NetheriteStemGrown(Block.Properties.from(Blocks.ANCIENT_DEBRIS));
    });
	//作物 连接茎
    ...
    public static RegistryObject<Block> attNetheriteStem = BLOCKS.register("att_netherite_stem", () -> {
        return new AttachedStemCrop((StemGrownBlock) netheriteLeanOre.get(),STEM);
    });
    //作物方块 茎
    ...
    public static RegistryObject<Block> netheriteStem = BLOCKS.register("netherite_stem", () -> {
        return new StemCrop(STEM, (StemGrownBlock) netheriteLeanOre.get());
    });
    ...
    public static RegistryObject<Block> netheriteCrop = BLOCKS.register("netherite_crop", () -> {
        return new OreCropBlock(STEM);
    });
    ...
    public static RegistryObject<Block> netheriteLeaf = BLOCKS.register("netherite_leaf", () -> {
        return new LeavesBlock(LEAF);
    });
    public static RegistryObject<Block> netheriteSapling = BLOCKS.register("netherite_sapling", () -> {
        return new OreSapling(new NetheriteTree(), SAPLING);
    });
}
