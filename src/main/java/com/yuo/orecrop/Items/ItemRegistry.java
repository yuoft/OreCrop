...
public class ItemRegistry {
	...
	public static RegistryObject<Item> netheriteNugget = ITEMS.register("netherite_nugget", () -> {
		return new OrdinaryItem();
	});
	...
	public static RegistryObject<Item> netheriteFruit = ITEMS.register("netherite_fruit", () -> {
		return new OrdinaryItem();
	});
	...
	public static RegistryObject<BlockItem> netheriteLeanOre = ITEMS.register("netherite_lean_ore", () ->{
		return new BlockItem(BlockRegistry.netheriteLeanOre.get(), GROUP);
	});
	...
	public static RegistryObject<BlockItem> netheriteStemSeed = ITEMS.register("netherite_stem_seed", () ->{
		return new BlockItem(BlockRegistry.netheriteStem.get(), GROUP);
	});
	...
	public static RegistryObject<BlockItem> netheriteCropSeed = ITEMS.register("netherite_crop_seed", () ->{
		return new BlockItem(BlockRegistry.netheriteCrop.get(), GROUP);
	});
	...
	public static RegistryObject<BlockItem> netheriteLeaf = ITEMS.register("netherite_leaf", () ->{
		return new BlockItem(BlockRegistry.netheriteLeaf.get(), GROUP);
	});
	public static RegistryObject<BlockItem> netheriteSapling = ITEMS.register("netherite_sapling", () ->{
		return new BlockItem(BlockRegistry.netheriteSapling.get(), GROUP);
	});
}
